...
- [Board for programs as transition systems]({{ site.baseurl }}{% link _lessons/06-dafny-invariants/board.png %})

### Recommended readings

- Lectures notes by Cesare Tinelli:
  - [Arrays in Dafny (part I)]({{ site.baseurl }}{% link _lessons/06-dafny-invariants/cesare-arrays.pdf %})
  - [Arrays in Dafny (part II)]({{ site.baseurl }}{% link _lessons/06-dafny-invariants/cesare-arrays-ii.pdf %})
