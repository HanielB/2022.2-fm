...
- [Lein13]({{ site.baseurl }}{% link _lessons/07-dafny-oo/Lein13.pdf %}) and [Herb11]({{ site.baseurl }}{% link _lessons/07-dafny-oo/Herb11.pdf %}), tutorial and lecture notes on Dafny
...
From [Lein13]({{ site.baseurl }}{% link _lessons/07-dafny-oo/Lein13.pdf %}):
